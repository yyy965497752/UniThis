        ...
        <div class="auth-form">
          ...
          <vue-form :state="formstate" v-model="formstate" @submit.prevent="onSubmit">
            ...
            <validate class="form-group required-field" :class="fieldClassName(formstate.password)" auto-label>
              ...
              <field-messages class="form-control-feedback" name="password" show="$touched || $submitted" auto-label>
                <div>Success!</div>
            ...
            <validate class="form-group required-field" auto-label :class="fieldClassName(formstate.confirmPassword)">
