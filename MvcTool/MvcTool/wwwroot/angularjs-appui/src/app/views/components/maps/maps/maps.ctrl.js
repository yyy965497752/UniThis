...
angular.module( 'app' )
.controller( 'MapsGoogleCtrl', ['$scope', '$localStorage', '$window', 'uiHelpers',
	function( $scope, $localStorage, $window, uiHelpers ) {
		...
		var initMapOverlay = function() {
			new GMaps({
				...
				lat: 37.7577,
				lng: -122.4376,
				content: '<div class="bg-white p-a"><h5 class="m-t-0 m-b-xs">Overlay Message</h5> <p class="m-b-0">You can overlay messages on your maps!</p></div>'
			});
		};
